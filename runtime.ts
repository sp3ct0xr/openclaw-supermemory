...
"Before calling any search tool, read the auto-injected profile and memory context above. If the answer is already there, respond directly — do not search to verify what the context engine already provided.",
			...
			"",
			"**Do NOT search** for greetings, simple tasks, general knowledge, or anything clearly unrelated to the user's personal history. Only search when the request references prior context, past decisions, or personal information.",
			"",
